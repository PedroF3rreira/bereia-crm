...
<div class="col-xl-6 col-md-6 mb-4">
	...
	<form class="user" action="<?= url().'/login' ?>" method="post" enctype="multipart/form-data">
		<div class="form-group d-flex">
			<input type="text" class="form-control form-control-user mr-2"
			id="exampleInputEmail" aria-describedby="emailHelp"
			placeholder="Primeiro nome" name="first_name" >
			<input type="text" class="form-control form-control-user"
			 placeholder="Segundo nome" name="last_name">
		</div>
		...
		<div class="form-group d-flex">
			<input type="text" class="form-control form-control-user mr-2"
			 placeholder="cel: (88)98888-8888" name="tel" id="campoTelefone">
			 <input type="text" class="form-control form-control-user"
